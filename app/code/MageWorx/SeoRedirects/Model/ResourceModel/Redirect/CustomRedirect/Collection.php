...
//        $this->conn = $conn;
    ...
    {
        $this->_init('MageWorx\SeoRedirects\Model\Redirect\CustomRedirect', 'MageWorx\SeoRedirects\Model\ResourceModel\Redirect\CustomRedirect');
    }
    ...
    {
        $this->getSelect()->where('main_table.status = ?', \MageWorx\SeoRedirects\Model\Redirect\CustomRedirect::STATUS_ENABLED);
        return $this;
    }
